...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'incident-add': RouteRecordInfo<'incident-add', '/incident/add', Record<never, never>, Record<never, never>>,
    'incident-edit-id': RouteRecordInfo<'incident-edit-id', '/incident/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'location-add': RouteRecordInfo<'location-add', '/location/add', Record<never, never>, Record<never, never>>,
    'location-edit-id': RouteRecordInfo<'location-edit-id', '/location/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
